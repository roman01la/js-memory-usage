...
var _user$project$Memwatch$record = F2(
	function (description, thunk) {
		return A2(
			_elm_lang$core$Task$map,
			F2(
				function (v0, v1) {
			...
			A2(_user$project$Native_Memwatch.record, 1000, thunk));
	});

var _user$project$Main$setOfSize = function (size) {
	var helper = F2(
		function (size, acc) {
			helper:
			while (true) {
				if (_elm_lang$core$Native_Utils.eq(size, 0)) {
					return acc;
				} else {
					var _v0 = size - 1,
						_v1 = A2(_elm_lang$core$Set$insert, size, acc);
					size = _v0;
					acc = _v1;
					continue helper;
				}
	...
	return A2(helper, size, _elm_lang$core$Set$empty);
};
var _user$project$Main$dictOfSize = function (size) {
	var helper = F2(
		function (size, acc) {
			helper:
			while (true) {
	...
	return A2(helper, size, _elm_lang$core$Dict$empty);
};
var _user$project$Main$listOfSize = function (size) {
	return A2(_elm_lang$core$List$repeat, size, 0);
};
var _user$project$Main$arrayOfSize = function (size) {
	return A2(
		_Skinney$elm_array_exploration$Array_Hamt$initialize,
		size,
...
var _user$project$Main$record = F2(
	function (description, thunk) {
		return A2(
			...
			A2(_user$project$Memwatch$record, description, thunk));
	});
var _user$project$Main$emit = _elm_lang$core$Native_Platform.outgoingPort(
	'emit',
	function (v) {
		return v;
	});
var _user$project$Main$printData = function (data) {
	return _user$project$Main$emit(
		_elm_lang$core$Json_Encode$object(
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Tuple$mapSecond(_elm_lang$core$Json_Encode$float),
				data)));
};
var _user$project$Main$update = F2(
	function (_p1, _p0) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$printData(_p2._0),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$GotData = function (a) {
	return {ctor: 'GotData', _0: a};
};
var _user$project$Main$buildData = A2(
	_elm_lang$core$Task$perform,
	_user$project$Main$GotData,
	A2(
		_elm_lang$core$Task$map,
		...
		A3(
			...
			'1000 item set',
			function (_p3) {
				return _user$project$Main$setOfSize(1000);
			},
			A3(
				_user$project$Main$record,
				'1000 item dict',
				function (_p4) {
					return _user$project$Main$dictOfSize(1000);
				},
				A3(
					_user$project$Main$record,
					'1000 item array',
					function (_p5) {
						return _user$project$Main$arrayOfSize(1000);
					},
					A3(
						_user$project$Main$record,
						'1000 item list',
						function (_p6) {
							return _user$project$Main$listOfSize(1000);
						},
						A3(
							_user$project$Main$record,
							'100 item set',
							function (_p7) {
								return _user$project$Main$setOfSize(100);
							},
							A3(
								_user$project$Main$record,
								'100 item dict',
								function (_p8) {
									return _user$project$Main$dictOfSize(100);
								},
								A3(
									_user$project$Main$record,
									'100 item array',
									function (_p9) {
										return _user$project$Main$arrayOfSize(100);
									},
									A3(
										_user$project$Main$record,
										'100 item list',
										function (_p10) {
											return _user$project$Main$listOfSize(100);
										},
										A3(
											_user$project$Main$record,
											'10 item set',
											function (_p11) {
												return _user$project$Main$setOfSize(10);
											},
											A3(
												_user$project$Main$record,
												'10 item dict',
												function (_p12) {
													return _user$project$Main$dictOfSize(10);
												},
												A3(
													_user$project$Main$record,
													'10 item array',
													function (_p13) {
														return _user$project$Main$arrayOfSize(10);
													},
													A3(
														_user$project$Main$record,
														'10 item list',
														function (_p14) {
															return _user$project$Main$listOfSize(10);
														},
														A3(
															_user$project$Main$record,
															'empty set',
...
var _user$project$Main$main = _elm_lang$core$Platform$program(
	{
		init: A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$buildData,
				_1: {ctor: '[]'}
			}),
