...
function fillMap(_cnt, _obj) {
  while(true) {
    ...
    var cnt = _cnt;
    if (cnt > 0) {
      _obj = Curry._3(TestMap[/* add */3], "key-" + Pervasives.string_of_int(cnt), 0, obj);
      _cnt = cnt - 1 | 0;
      continue ;
...
var results = {
  ...
  "10 item Array": record(1000, (function () {
          return Caml_array.caml_make_vect(10, 0);
        })),
  ...
  "100 item Array": record(1000, (function () {
          return Caml_array.caml_make_vect(100, 0);
        })),
  ...
  "1000 item Array": record(1000, (function () {
          return Caml_array.caml_make_vect(1000, 0);
        })),
